...
**Tech Stack:** C# / .NET 10.0, Ixian-Core library
...
### [Building a Payment Gateway](./quickstart/payment-gateway)

**Best for:** E-commerce, web services, exchanges

Build a robust IXI payment gateway using QuIXI for accepting and sending payments.

**Tech Stack:** Python, Node.js, HTTP/MQTT
...
[Build a Payment Gateway ->](./quickstart/payment-gateway)
...
| Payment processor | [Payment Gateway](./quickstart/payment-gateway) |
