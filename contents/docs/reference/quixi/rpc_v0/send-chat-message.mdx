...
*   **Dual End-to-End Encryption:** The `message` content is encrypted locally using the established session keys before being transmitted. Only the intended recipient can decrypt it.
